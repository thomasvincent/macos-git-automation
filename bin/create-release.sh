...
echo "     when the tag is pushed. You do not need to run bin/create-github-releases.sh manually."
echo ""
...
echo ""
echo "Note: If you need to create releases for historical tags, you can use bin/create-github-releases.sh"
echo "      which will check for existing releases and only create missing ones."
echo ""
